...
// page.off('dialog', alertDialog)
    ...
    await expect(page.locator("//h2[text()='JavaScript Confirm Box']/following-sibling::p")).toBeVisible({ timeout: 30000 })
    await expect(page.locator("//h2[text()='JavaScript Confirm Box']/following-sibling::p")).toHaveText("You pressed OK!")
